...
new function (_D) {
    ...
    var _16 = detect("(jscript)") ? new RegExp("^" + rescape(isNaN).replace(/isNaN/, "\\w+") + "$") : {
        test: False
    };
    var _17 = 1;
    ...
    function assignID(a) {
        if (!a.base2ID) a.base2ID = "b2_" + _17++;
        return a.base2ID
    };
    var _G = function (a, b) {
    ...
    var Enumerable = Module.extend({
        every: function (c, d, f) {
            var g = true;
            try {
                forEach(c, function (a, b) {
                    g = d.call(f, a, b, c);
                    if (!g) throw StopIteration;
                })
            } catch (error) {
    ...
    var Map = Base.extend({
        ...
        has: function (a) { /*@cc_on @*/ /*@if(@_jscript_version<5.5)return $Legacy.has(this,_2+a);@else @*/
            return _2 + a in this; /*@end @*/
        },
        merge: function (b) {
            var c = flip(this.put);
            ...
            return h.replace(new RegExp(this, this.ignoreCase ? "gi" : "g"), function (a) {
                ...
                while ((b = j[_2 + k[d++]])) {
                    ...
                    if (arguments[c]) {
                        ...
                        switch (typeof g) {
                        case "function":
                            return g.apply(j, _5.call(arguments, c, f));
                        case "number":
                            return arguments[c + g];
                        default:
                            return g
                        }
                    }
        ...
        if (a && b) {
            ...
            for (c in b) {
                if (d[c] === undefined) {
                    var g = b[c];
                    if (c.charAt(0) == "@") {
                        if (detect(c.slice(1))) extend(a, g)
                    } else {
                        var h = a[c];
    ...
    function _J(a, b, c) {
        ...
        if (typeof a == "string") {
            ...
            for (f = 0; f < d; f++) { /*@cc_on @*/ /*@if(@_jscript_version<5.2)if($Legacy.has(a,f))@else @*/
                if (f in a) /*@end @*/ b.call(c, a[f], f, a)
            }
        }
    };
    ...
    function typeOf(a) {
        ...
        switch (b) {
        case "object":
            return a == null ? "null" : typeof a.constructor == "undefined" ? _16.test(a) ? "function" : b : typeof a.constructor.prototype.valueOf();
        case "function":
    ...
    var Array2 = _i(Array, Array, "concat,join,pop,push,reverse,shift,slice,sort,splice,unshift", Enumerable, {
    ...
    var Date2 = _i(Date, function (a, b, c, d, f, g, h) {
        ...
        default:
            return new Date(a, b, arguments.length == 2 ? 1 : c, d || 0, f || 0, g || 0, h || 0)
        }
    }, "", {
    ...
    Date2.parse = function (a, b) {
        ...
        var c = match(a, _1i);
        if (c.length) {
            if (c[_a.Month]) c[_a.Month]--;
            if (c[_8.Hectomicroseconds] >= 5) c[_a.Milliseconds]++;
            var d = new Date(b || 0);
    ...
    var Function2 = _i(Function, Function, "", {
        I: I,
        II: II,
        K: K,
        bind: bind,
    ...
    function detect() {
        ...
        if (global.navigator) {
            ...
            if (!f) j = j.replace(h, "");
            if (h.test(j)) j = j.match(h)[0] + " " + j.replace(h, "");
...
new function (_D) {
    ...
    var Traversal = Module.extend({
        ...
        "@!MSIE": {
            setTextContent: function (a, b, c) {
                with(a) while (lastChild) parentNode.removeChild(lastChild);
    ...
    var _e = 1,
        _R = 2,
        _m = 3;
    var _S = /^mouse(up|down)|click$/,
        _1l = /click$/,
        _t = "abort|error|select|change|resize|scroll|",
        _n = "(dbl)?click|mouse(down|up|over|move|out|wheel)|key(down|up)|submit|reset";
    _t = new RegExp("^(" + _t + _n + ")$");
    _n = new RegExp("^(" + _n + ")$");
    if (_9) {
        var _1m = {
    ...
    var EventTarget = Interface.extend({
        ...
        "@(element.addEventListener)": {
            "@Gecko": {
                addEventListener: function (b, c, d, f) {
                    if (c == "mousewheel") {
                        c = "DOMMouseScroll";
                        var g = d;
            ...
            "@webkit[1-4]|KHTML[34]": {
                addEventListener: function (c, d, f, g) {
                    if (_S.test(d)) {
                        var h = f;
            ...
            "@Linux|Mac|opera": {
                addEventListener: function (g, h, i, j) {
                    if (h == "keydown") {
                        var k = i;
    ...
    var _1n = /^\d+(px)?$/i,
        _U = /(width|height|top|bottom|left|right|fontSize)$/,
        _V = /^(color|backgroundColor)$/,
        _1o = "rgb(0, 0, 0)",
        _1p = {
            black: 1,
            "#000": 1,
    ...
    var ViewCSS = Interface.extend({
        ...
        "@MSIE": {
            getComputedPropertyValue: function (a, b, c) {
                ...
                if (_U.test(c)) return _1q(b, d) + "px";
                if (!_j && _V.test(c)) {
    ...
    function _1q(a, b) {
        if (_1n.test(b)) return parseInt(b);
        var c = a.style.left;
    ...
    var CSSStyleDeclaration = _W.extend({
    ...
    var NodeSelector = Interface.extend({
        "@(element.querySelector)": {
            ...
            querySelectorAll: function (a, b) {
                try {
                    var c = this.base(a, trim(b));
                    if (c) return new StaticNodeList(c)
                } catch (x) {}
    ...
    var XPathParser = CSSParser.extend({
        ...
        rules: extend({}, {
            ...
            "@!KHTML": {
                "([ >])(\\*|[\\w-]+):([\\w-]+-child(\\(([^)]+)\\))?)": function (a, b, c, d, f, g) {
                    var h = (b == " ") ? "//*" : "/*";
                    if (/^nth/i.test(d)) {
                        h += _w(d, g, "position()")
                    } else {
    ...
    var Selector = Base.extend({
        ...
        isSimple: function () {
            if (!_6.exec) _6 = new CSSParser(_6);
    ...
    var _Z = document.documentElement.sourceIndex !== undefined,
        _10 = "var p%2=0,i%2,e%3,n%2=e%1.",
        _1C = _Z ? "e%1.sourceIndex" : "assignID(e%1)",
        _1D = "var g=" + _1C + ";if(!p[g]){p[g]=1;",
        _1E = "r[k++]=e%1;if(s==1)return e%1;if(k===s){_g.state=[%2];_g.complete=%3;return r;",
        _1F = "var _g=function(e0,s%1){_h++;var r=[],p={},p0=0,reg=[%4],d=Traversal.getDocument(e0),c=d.writeln?'toUpperCase':'toString',k=0;";
    var _y;
    ...
    var _6 = {
        ...
        " (\\*|[\\w-]+)#([\\w-]+)": function (a, b, c) {
            ...
            if (_4[_7]) d += format("i%1=n%1.length;", sum(_4));
        ...
        "#([\\w-]+)": function (a, b) {
            _3 = false;
            var c = "if(e%1.id=='%2'){";
            if (_4[_7]) c += format("i%1=n%1.length;", sum(_4));
            return format(c, _1, b)
        },
        "\\.([\\w-]+)": function (a, b) {
            _3 = false;
        ...
        Selector.parse = function (a, b) {
            ...
            if (!c[a]) {
                ...
                if (k) {
                    ...
                    for (var l = 0; l < _7; l++) {
                        n += _4[l];
                        if (_4[l]) m.push(format("n%1&&i%1==n%1.length", n))
                    }
                }
    ...
    var DocumentState = Base.extend({
        ...
        "@!(element.addEventListener)": {
            ...
            registerEvent: function (b, c) {
                ...
                var f = _T.test(b);
                if (!d || !f) {
                    if (!d) d = this.events[b] = {};
                    if (f || !c) c = this.document;
                    var g = this;
                    c["on" + b] = function (a) {
                        if (!a) {
                            a = Traversal.getDefaultView(this).event
                        }
                        if (a) g.handleEvent(a)
                    }
                }
                return d
            },
            "@MSIE.+win": {
                ...
                setFocus: function (b) {
                    var c = this.events.change,
                        d = this.events.select;
                    if (c || d) {
                        var f = this._q;
                        if (c) b.attachEvent("onchange", f);
                        if (d) {
                            var g = this;
                            var h = function (a) {
                                if (g._B == b) {
                        ...
                        b.attachEvent("onblur", function () {
                            ...
                            if (c) b.detachEvent("onchange", f);
                            if (d) b.detachEvent("onselect", h)
                        })
                    }
                },
